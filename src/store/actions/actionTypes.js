...
export const AUTH_FAIL = 'AUTH_FAIL',
    ...
    GET_SELECTOR_TOOL_TIP = 'GET_SELECTOR_TOOL_TIP',
...
export const GET_DOCTOR_TODAY_INFO = 'GET_DOCTOR_TODAY_INFO',
    ...
    GET_DOCTOR_SPECIALITIES = 'GET_DOCTOR_SPECIALITIES',
    GET_AVAIL_LANGUAGES = 'GET_AVAIL_LANGUAGES',
    GET_AVAIL_PROFS = 'GET_AVAIL_PROFS',
    GET_AVAIL_LANGUAGES_DOCTORDATA = 'GET_AVAIL_LANGUAGES_DOCTORDATA',
    GET_DOCTOR_SPECIALITIES_DOCTORDATA = 'GET_DOCTOR_SPECIALITIES_DOCTORDATA',
...
export const GET_DOCTORS_LOCATION = 'GET_DOCTORS_LOCATION',
    GET_DOCTORS_LOCATION_ERROR = 'GET_DOCTORS_LOCATION_ERROR';

export const GET_PATIENT_LOCATION = 'GET_PATIENT_LOCATION';

export const TOGGLE_CHAT_FILES_AREA = 'TOGGLE_CHAT_FILES_AREA',
    TOGGLE_CHAT_MESSAGES_AREA = 'TOGGLE_CHAT_MESSAGES_AREA',
    SET_CHAT_MESSAGES_ACTIVE_AREA = 'SET_CHAT_MESSAGES_ACTIVE_AREA',
    RESET_CHAT_ACTIVE_AREAS = 'RESET_CHAT_ACTIVE_AREAS',
    SET_FULLSCREEN_MODE = 'SET_FULLSCREEN_MODE',
    EXIT_FULLSCREEN_MODE = 'EXIT_FULLSCREEN_MODE';