                    ...
                    (<div className='review-root'>
                        ...
                        <div className="patient-info">
                            ...
                            {!this.props.isOnDoctorPage && <Button
                                btnText={translate('treatment.fromDate', {date: (moment.unix(+makingAppDate)).format('DD.MM.YYYY')})}
                                size='go'
                                iconSize={16}
                                type='go'
                             ...
                             <div className="review-answerBtn">
                            {
                                isSecondAllowed && (commentDoc ?
                                    <Button btnText={this.state.showComment ? translate('button.title.hideAnswer') : translate('button.title.showAnswer')}
                                            size='file'
                                            type='file'
                                    ...
                                    (isDoctor && !this.props.isOnDoctorPage && !commentDoc && !this.state.showAnswerArea &&
                                        <Button onClick={this.showAnswArea}
                                                btnText={translate('button.title.reply')}
                                                size='mini'
                                                type='blue'
